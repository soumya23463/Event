        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="scroll-animate">
                    ...
                    <p class="about-text">Krishna Events is a premier Wedding and Event Management Company based in Jaipur, Rajasthan. We specialize in creating magical moments and unforgettable experiences for our clients across India.</p>
                    <p class="about-text">With years of expertise in destination wedding planning and event management, we have successfully organized countless events in major cities including Jaipur, Udaipur, Jodhpur, Pushkar, Goa, Kerala, Mumbai, Delhi, Agra, Manali, and Shimla.</p>
                    <p class="about-text">Our team of dedicated professionals brings creativity, passion, and meticulous attention to detail to every project, ensuring that your special day is exactly as you envisioned it.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="scroll-animate delay-2">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about-company.jpg"
                         alt="Krishna Events Team"
                         class="img-fluid about-image"
                         onerror="this.src='https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&h=600&fit=crop'">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="info-card scroll-animate">
                    ...
                    <h3>Our Mission</h3>
                    <p>To offer a service that sets new trends in the wedding and event management industry. We strive to create personalized, memorable experiences that exceed our clients' expectations through innovation, creativity, and exceptional service.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="info-card scroll-animate delay-2">
                    ...
                    <h3>Our Vision</h3>
                    <p>To become India's most trusted and sought-after event management company, known for our commitment to quality, creativity, and customer satisfaction. We aim to transform every event into a beautiful memory that lasts a lifetime.</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="why-choose-us" class="py-5 bg-white">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="section-title-simple scroll-animate">Why Choose Krishna Events?</h2>
            <p class="lead scroll-animate delay-1">What Makes Us Different</p>
        </div>
        <div class="row g-4">
            <div class="col-md-6 col-lg-3">
                <div class="feature-box scroll-animate">
                    ...
                    <p>Every event is unique, and we provide customized solutions tailored to your specific needs and preferences.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="feature-box scroll-animate delay-1">
                    <div class="feature-icon">
                        <i class="fa fa-globe"></i>
                    </div>
                    <h4>Pan-India Network</h4>
                    <p>Extensive network of trusted vendors across major cities in India for seamless event execution.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="feature-box scroll-animate delay-2">
                    <div class="feature-icon">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="feature-box scroll-animate delay-3">
                    <div class="feature-icon">
...
<section id="services-overview" class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead scroll-animate delay-1">Complete Event Management Solutions</p>
        </div>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="service-list-card scroll-animate">
                    <i class="fa fa-check-circle"></i>
                    <h5>Destination Wedding Planning</h5>
                </div>
            </div>
            <div class="col-md-4">
                <div class="service-list-card scroll-animate">
                    <i class="fa fa-check-circle"></i>
                    <h5>Venue Selection & Decoration</h5>
                </div>
            </div>
            <div class="col-md-4">
                <div class="service-list-card scroll-animate">
            ...
            <div class="col-md-4">
                <div class="service-list-card scroll-animate delay-1">
                    <i class="fa fa-check-circle"></i>
...
<section id="quality-policy" class="py-5 bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <div class="scroll-animate delay-2">
                    ...
                    <p class="about-text">At Krishna Events, quality is not just a promise – it's our foundation. We are committed to:</p>
                    <ul class="quality-list">
                        <li><i class="fa fa-star"></i> Delivering exceptional service that exceeds client expectations</li>
                        <li><i class="fa fa-star"></i> Maintaining the highest standards in every aspect of event management</li>
                        <li><i class="fa fa-star"></i> Continuous improvement through client feedback and industry best practices</li>
                        <li><i class="fa fa-star"></i> Building long-term relationships based on trust and reliability</li>
                        <li><i class="fa fa-star"></i> Ensuring complete client satisfaction from planning to execution</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section id="about-cta" class="py-5 bg-gradient-primary text-white section-overlay">
    <div class="container text-center">
        <div class="scroll-animate">
            ...
            <p class="lead mb-4" style="font-size: 1.2rem;">Let's create something magical together. Contact us today for a free consultation!</p>
            <a href="#contact-section" class="btn btn-light btn-lg" style="padding: 15px 40px; font-weight: 600;">
